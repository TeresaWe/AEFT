...
AEFT_ins_0<-function(AEFTtable){
  ...
  return (c(Ins_0_corr,Ins_0_meanRT))
}
...
AEFT_ins_6<-function(AEFTtable){
  ...
  return (c(Ins_6_corr,Ins_6_meanRT))
}
...
AEFT_ins_12<-function(AEFTtable){
  ...
  return (c(Ins_12_corr,Ins_12_meanRT))
}
...
AEFT_ins_24<-function(AEFTtable){
  ...
  return (c(Ins_24_corr,Ins_24_meanRT))
}
...
AEFT_miss_0<-function(AEFTtable){
  ...
  return (c(miss_0_corr,miss_0_meanRT))
}
...
AEFT_miss_6<-function(AEFTtable){
  ...
  return (c(miss_6_corr,miss_6_meanRT))
}
...
AEFT_miss_12<-function(AEFTtable){
  ...
  return (c(miss_12_corr,miss_12_meanRT))
}
...
AEFT_miss_24<-function(AEFTtable){
  ...
  return (c(miss_24_corr,miss_24_meanRT))
}
